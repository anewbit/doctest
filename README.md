...
扣子罗盘在商业化版本的基础上推出社区版，免费对开发者开放核心基础功能模块，以开源模式共享核心技术框架。社区版后端采用 Golang 开发，前端使用 React + Typescript 开发，基于微服务架构，遵循领域驱动设计（DDD）原则构建。开发者可根据业务需求定制与扩展，便于社区共建、分享交流，助力开发者零门槛参与 AI Agent 的探索与实践。
